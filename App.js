...
const productItem = ({ item , color}) => (  

<View style={{flexDirection:'column', margin:20 ,  color }}>
...
<Text> uStock : {item.unitsInStock}</Text>
</View>
<View>


<Text> Order : {item.unitsOnOrder}</Text>
<Text> Level : {item.reorderLevel}</Text>
</View>
...
//nəsə xəta verir amma səbəbini tutmadım müəllim
...
//   <View style={{flexDirection:'column', margin:20 , backgroundColor:'red'}}>
